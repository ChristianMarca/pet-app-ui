...
function UserItem({ user }: IProps): React.ReactElement {
    return (
        <div className="shadow p-4 my-2 flex justify-around w-full rounded">
            <svg
                className="svg-icon blu"
                viewBox="0 0 20 20"
                style={{ fill: '#2E2E2E', width: '1.5em', height: '1.5em' }}
            >
